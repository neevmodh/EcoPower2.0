...
const DiscomPage = () => {
    ...
    const handleExport = () => {
        const header = "id,date,time,type,kwh,rate,amount,reference,status\n";
        const rows = mockGridTx.map(t => `${t.id},${t.date},${t.time},${t.type},${t.kwh},${t.rate},${t.amount},${t.reference},${t.status}`).join('\n');
