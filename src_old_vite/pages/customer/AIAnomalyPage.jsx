...
If no anomalies are found, return an empty array for 'anomalies', healthScore = 100, and overallHealth = "Excellent".`;
    ...
    const handleCreateTicket = async (anomaly) => {
        ...
        try { setCsvData(prev => ({ ...prev, tickets: [...prev.tickets, newTicket] })); refreshData(); window.dispatchEvent(new CustomEvent('eco-toast', { detail: { message: `Ticket ${newId} raised!`, type: 'success' } })); }
